...
@Service
@Profile("p2")
class BookP2ServiceImpl implements BookService {

    private final BookRepository bookRepository;

    private final CacheService<Book, Integer> cacheService;

    //@Lazy -> All parameters will be lazy
    BookP2ServiceImpl(BookRepository bookRepository, @Lazy CacheService<Book, Integer> cacheService) {
