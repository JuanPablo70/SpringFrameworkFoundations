...
public class BookServiceReportTests {
    ...
    private BookService bookServiceA;
    private BookService bookServiceB;
    ...
    static void beforeAll() {
        ...
        System.out.println("******************");
        ctx = new AnnotationConfigApplicationContext("com.juan.sanchez.config");
    }
    ...
    void beforeEach() {
        ...
        bookServiceA = ctx.getBean(BookService.class);
        bookServiceA.setDefaultId(15);

        bookServiceB = ctx.getBean(BookService.class);
        bookServiceB.setDefaultId(27);
    }

    @Test
    @Order(1)
    @DisplayName("Testing Report - 'findByDefaultId'")
    void reportFindByDefaultIdTest() {
        System.out.println("---------------------------");
