...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("****************************************");
        System.out.println("Main - 'spring-framework-tx-jdbc-c' - Start");
        System.out.println("****************************************");
        ...
        try {
            ...
            System.out.println(" [Main] Catching and Handling Throwable");
        ...
        System.out.println("");
        System.out.println("*************************************");
        System.out.println("Main - 'spring-framework-tx-jdbc-c' - End");
        System.out.println("*************************************");
    }
}