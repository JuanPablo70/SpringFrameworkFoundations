...
public class BookP2JdbcRepository implements BookRepository, InitializingBean, DisposableBean {

    private DataSource dataSource;

    public BookP2JdbcRepository(DataSource dataSource) {
    ...
    public void afterPropertiesSet() throws Exception {
        System.out.println("BookRepository - afterPropertiesSet - Data: " + this.count());
    }

    @Override
    public void destroy() throws Exception {
        System.out.println("BookRepository - destroy - Data: " + this.count());
    }
