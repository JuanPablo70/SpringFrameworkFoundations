...
public class BookP4JdbcRepository implements BookRepository {

    private DataSource dataSource;

    public BookP4JdbcRepository(DataSource dataSource) {
    ...
    private void postConstruct() {
        System.out.println("BookRepository - postConstruct - Data: " + this.count());
    }

    @PreDestroy
    private void preDestroy() {
        System.out.println("BookRepository - preDestroy - Data: " + this.count());
    }
