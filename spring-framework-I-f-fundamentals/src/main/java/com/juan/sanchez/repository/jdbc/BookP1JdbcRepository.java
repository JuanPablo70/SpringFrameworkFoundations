...
public class BookP1JdbcRepository implements BookRepository {

    private DataSource dataSource;

    public BookP1JdbcRepository(DataSource dataSource) {
    ...
    public Book save(Book book) {
        ...
        try(Connection conn = dataSource.getConnection();
            ...
            ps.setDate(4, java.sql.Date.valueOf(book.getPublishDate()));
