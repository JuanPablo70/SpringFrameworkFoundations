...
public class BookP4ServiceImpl implements BookService {

    private BookRepository bookRepository;

    public BookP4ServiceImpl(BookRepository bookRepository) {
    ...
    private void postConstruct() {
        System.out.println("BookService - postConstruct - Data: " + this.count());
    }

    @PreDestroy
    private void preDestroy() {
        System.out.println("BookService - preDestroy - Data: " + this.count());
    }
