...
public class BookP2ServiceImpl implements BookService, InitializingBean, DisposableBean {

    private BookRepository bookRepository;

    public BookP2ServiceImpl(BookRepository bookRepository) {
    ...
    public void afterPropertiesSet() throws Exception {
        System.out.println("BookService - afterPropertiesSet - Data: " + this.count());
    }

    @Override
    public void destroy() throws Exception {
        System.out.println("BookService - destroy - Data: " + this.count());
    }
