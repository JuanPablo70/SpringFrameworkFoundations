...
class BookCacheServiceImpl implements CacheService<Book, Integer> {
    ...
    private void postConstruct() {
        System.out.println("CacheService - postConstruct - data: " + this.cache.size());
        System.out.println("                             - Starting Cache");
    }

    @PreDestroy
    private void preDestroy() {
        System.out.println("CacheService - preDestroy - data: " + this.cache.size());
        System.out.println("                          - Cleaning Cache");
        this.cache.clear();
        System.out.println("                          - Data: " + this.cache.size());
    }
