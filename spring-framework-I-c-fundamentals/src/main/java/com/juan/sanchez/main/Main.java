...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("****************************************");
        System.out.println("Main - 'spring-framework-I-c-fundamentals' - Start");
        System.out.println("****************************************");
        ...
        Optional.ofNullable(System.getProperty("spring.application.context.report"))
                        .ifPresent(t -> {
                            if (t.equals("true")) {
                                SpringFrameworkUtils.beansDefinitionsReport(ctx);
                            }
                        });
        ctx.close();
        ...
        System.out.println("");
        System.out.println("*************************************");
        System.out.println("Main - 'spring-framework-I-c-fundamentals' - End");
        System.out.println("*************************************");
    }
}